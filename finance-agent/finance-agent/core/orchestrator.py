...
QUALITY_EVAL_PROMPT = """You are a strict quality evaluator for financial analysis workflows.

Evaluate the following workflow output against these criteria:

1. DATA COMPLETENESS (0-25): Was all relevant data fetched and used? Are there gaps?
2. ANALYSIS DEPTH (0-25): Does the analysis include precise calculations, trends, and actionable recommendations? Or is it shallow/generic?
3. VISUAL QUALITY (0-25): Were charts generated? Do they cover the key data points? Are multiple chart types used where appropriate?
4. DOCUMENT QUALITY (0-25): If a document was requested — is the structure logical? Are charts embedded? Is formatting professional?

Respond with ONLY valid JSON:
{
  "total_score": 0-100,
  "data_completeness": {"score": 0-25, "feedback": "..."},
  "analysis_depth": {"score": 0-25, "feedback": "..."},
  "visual_quality": {"score": 0-25, "feedback": "..."},
  "document_quality": {"score": 0-25, "feedback": "..."},
  "pass": true/false,
  "critical_issues": ["issue1", ...],
  "improvement_instructions": "What to do differently in the next iteration"
}

A score of 70+ passes. Below 70 requires re-execution with improvements."""
    ...
    if not doc_exists:
        ...
        try:
            ...
            try:
                ...
                log.error("[STEP 5/5] All attempts exhausted — returning narrative only")
...
async def process_query(raw_query: str, output_format: str = "auto", conversation_history: list[dict] = None) -> dict:
    ...
    try:
        ...
        # If we have a partial best result, return it
